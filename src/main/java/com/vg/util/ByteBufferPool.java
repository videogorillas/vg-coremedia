 ...
 * </p>
 * <p>
 * Acquired buffers may be {@link #release(ByteBuffer) released} but they do not
 * need to; if they are released, they may be recycled and reused, otherwise
 * they will be garbage collected as usual.
 * </p>
 */
public interface ByteBufferPool {
    ...
    /**
     * <p>
     * Returns a {@link ByteBuffer}, usually obtained with
     * {@link #acquire(int, boolean)} (but not necessarily), making it available
